...
<center><body background="images/background.jpg">
	...
	<div class="editProfile" style="width:50%; height:auto; background-color:lightgrey; border: 2px solid #0b396d;">
	     ...
	     <input style="width:50%; height:5%; background-color:orange; "  type="text"  id="date"  required ><br><br>
		     <button type="button" style="width:30%; height:40px; background-color:lightgrey; border: 2px solid #0b396d;" onclick="myFunction()">View Schedule</button> 
         </form>
    <p id='demo1'></p>
...
function myFunction(){			
       ...
       xmlhttp.open("GET",'viewSchedule2.php?date='+date+'&id=<?php echo $_GET["id"];?>',true);
        xmlhttp.send();
