...
if (mysqli_num_rows($result) > 0) {
   ...
   echo'<table class="p-table">
		  <tr>
			  ...
			  if($row["report"]==""){
			  echo'<td style="height:30px;">Status: Pending</td>
			  <td style="height:30px; background-color:#0b396d;"><a href="add-patient-medicaltest2.php?testid= '.$row["Id"].'"><button>Add Report</button></td> 
			  ';
			  }else{
				echo'<td style="height:30px;"> '.$row["completeddate"].'</td>
				<td style="height:30px; background-color:#0b396d;"><a href="add-patient-medicaltest2.php?testid= '.$row["Id"].'"><button>Update</button></td> 
				';
			  }
